...
def on_message(ws, message):
    ...
    try:
        ...
        # We don't need 'ts' anymore because we aren't saving to DB here
        ...
        # We only update memory here. The new "Track B" loop 
        # handles saving history to the database efficiently.
        # ---------------------------------------------------------
